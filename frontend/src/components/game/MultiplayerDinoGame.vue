  ...
  methods: {
    ...
    async _applyStatePatchSerialized(patch) {
      ...
      if (
        ...
        //
        // Skipped for our own moves — we drove the click ourselves and
        // don't want the camera jerking away mid-turn.
        const isOwnMove =
          this.myPlayerOrder !== null && patch.movingUnit.player === this.myPlayerOrder
