...
`docs/` contains deeper docs maintained alongside the code: `architecture.md`, `game-engines.md`, `game-components.md`, `game-rules.md`, `mixins.md`, `sub-menu-pages.md` (back-arrow / title layout pattern + confirm-dialog usage for sub-menu pages — read this before adding a new full-screen page outside the in-game view), `scenarios.md` (pre-designed single-player maps and the map editor — engine-level rules like "fog blocks movement" and "only bases have owners", how to add a scenario, the lose/win rules and the saved-map flows), `tutorial.md` (scripted tutorial scenarios), `development-setup.md`, `testing.md` (frontend test stack, conventions and gotchas — read before adding tests), `troubleshooting.md`, `legal-compliance.md` (privacy/IP/security risk assessment — not legal advice), `deployment-guide.md`, `security-guidelines.md`, `api/`. Also: `LINTING.md` (lint ordering rationale), `HOWTO.md` (first-time setup).
