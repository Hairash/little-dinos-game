...
def calculate_visibility(
    ...
    for x in range(width):
        for y in range(height):
            ...
            has_player_unit = cell.get("unit") and cell["unit"].get("player") == player_order
            has_player_building = (
                cell.get("building") and cell["building"].get("player") == player_order
            )
